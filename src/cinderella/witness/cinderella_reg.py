...
from cinderella.template import get_linear_expression, get_template
...
class CLW:
    ...
    def find_witness(self) -> Any:
        ...
        #intermediate_goal = sp.Or(*[b > 1 - self.eps for b in self.buckets])
        ...
        """
        print(self.cs)
        self.cs.write_smt2(OUT_DIR / 'cinderella.smt2')
