"""
This module implements the cinderella-stepmother game.
...
specifically, it is a reachability game where the question is whether the
stepmother can reach a state where one of the buckets overflows. It can also
be seen as a safety game where the question is whether Cinderella can prevent
the stepmother from reaching such a state.
"""
import numpy as np
